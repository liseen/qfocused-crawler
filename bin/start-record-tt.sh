...
exec ttserver -port 19851 -thnum 30  -dmn -pid /tmp/qcrawler-record.pid -le -log ${LOG_FILE} "${DATA_DIR}/qcrawler-record.tct#bnum=10000000#opts=lb#rcnum=2000#xmsiz=536870912"
